public interface Messages {
    ...
    String MESSAGE4 = "No free space for new container to load";
    String MESSAGE5 = "Provide material type in String format: ";
    String MESSAGE6 = "Provide capacity in int format: ";
    String MESSAGE7 = "1. Create Heavy container";
    String MESSAGE8 = "2. Create container for Liquid Materials";
    String MESSAGE9 = "Select correct variety of container You want to create (1 or 2)";
    String MESSAGE10 = "No sender with such personal ID is found";
